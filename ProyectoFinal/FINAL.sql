...
CREATE TABLE `docente` (
  ...
  `DOCENTE_PERSONA` varchar(10) NOT NULL,
  PRIMARY KEY (`DOCENTE_ID`),
  KEY `FK_ID_PERSONA_idx` (`DOCENTE_PERSONA`),
  CONSTRAINT `FK_ID_PERSONA` FOREIGN KEY (`DOCENTE_PERSONA`) REFERENCES `persona` (`PERSONA_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `docente` VALUES (1,'INGENIERIO DE SISTEMAS','0101195964');
...
INSERT INTO `estudiante` VALUES (1,'2020-07-07','0101195964'),(3,'2020-07-07','0106149388'),(4,'2020-07-08','0101119594');
...
INSERT INTO `persona` VALUES ('0101119594','STEVEN','PALTA','CUENCA','rpalta',222,'M','1997-01-05'),('0101195964','WALTER','BAU','PAUTE','wbau',111,'M','1997-10-18'),('0106149388','JUNA','BAU','PAUTE','juan-marcel',222,'M','1999-12-15');
...
CREATE TABLE `usuario` (
  ...
  `USUARIO_NAMEUSER` varchar(45) NOT NULL,
  `USUARIO_PASSWORD` varchar(32) NOT NULL,
  `USUARIO_ROL` varchar(2) NOT NULL,
  `USUARIO_ESTADO` varchar(2) NOT NULL,
  `USUARIO_PERSONA_ID` varchar(10) NOT NULL,
  PRIMARY KEY (`USUARIO_ID`),
  KEY `FK_PERSONA_ID_idx` (`USUARIO_PERSONA_ID`),
  CONSTRAINT `FK_PERSONA_USUARIO_ID` FOREIGN KEY (`USUARIO_PERSONA_ID`) REFERENCES `persona` (`PERSONA_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'cuenca123','4994d2327732afa7a61cc0074cf7a526','U','A','0101195964');
...
-- Dump completed on 2020-07-15 20:12:26
